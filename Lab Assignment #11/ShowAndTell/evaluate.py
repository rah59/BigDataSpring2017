...
tf.flags.DEFINE_string("input_file_pattern", "data/tfdata/val-?????-of-00001",
                       "File pattern of sharded TFRecord input files.")
tf.flags.DEFINE_string("checkpoint_dir", "data/model/train",
                       "Directory containing model checkpoints.")
tf.flags.DEFINE_string("eval_dir", "data/model/eval", "Directory to write event logs.")

tf.flags.DEFINE_integer("eval_interval_secs", 600,
                        "Interval between evaluation runs.")
tf.flags.DEFINE_integer("num_eval_examples", 10000,
                        "Number of examples for evaluation.")

tf.flags.DEFINE_integer("min_global_step", 5,

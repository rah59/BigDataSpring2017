...
tf.flags.DEFINE_string("image_dir", "data/blog_images/",
                       "Image directory.")


tf.flags.DEFINE_string("captions_file", "data/blog_captions/captions.json",
                       "Captions JSON file.")
...
def main(unused_argv):
  ...
  raj21_dataset = _load_and_process_metadata(FLAGS.captions_file,
                                                    FLAGS.image_dir)
  ...
  train_cutoff = int(0.85 * len(raj21_dataset))
  val_cutoff = int(0.90 * len(raj21_dataset))

  train_dataset = raj21_dataset[0:train_cutoff]
  val_dataset = raj21_dataset[train_cutoff:val_cutoff]
  test_dataset = raj21_dataset[val_cutoff:]

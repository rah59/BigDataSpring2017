...
class ObjectMainDetection {
    ...
    public void StartVideo() throws IOException {
        Video<MBFImage> video = new XuggleVideo(new File("data/MySample.mkv"));
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("data/Bear.png"));
            modelImage2 = ImageUtilities.readMBF(new File("data/Tiger.png"));
            modelImage3 = ImageUtilities.readMBF(new File("data/Lion.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }

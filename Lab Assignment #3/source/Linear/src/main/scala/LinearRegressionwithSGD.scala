...
/**
  ...
  * Adopted by Raj on 2/7/2017 to create a linear model to determine correlation between age and # of feeding
  * Using this model we can estimate how much a chimp of age X will feed and groom in a given day.
  */
...
object LinearRegressionwithSGD {
  ...
  def main(args: Array[String]): Unit ={
    ...
    // Load and parse the Chimp feeding and Grooming data. The columns are age, #feeding #grooming
    val data = sc.textFile("data/feeding_grooming.data")

...
/**
  ...
  * Adopted by Raj on 2/7/2017 to cluster chimps based on their feeding habit
  * The data set contains the age of the chimp and the number of feedings per day
  * The goal is to classify the group of chimps into 2 clusters
  * One cluster is chimps that feed occasionally
  * Second cluster is chimps that feed often
  */
object kMeansClustering {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val data = sc.textFile("data/feeding_data.txt")
